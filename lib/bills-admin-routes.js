...
function handleError(res, err, fallbackMessage) {
  if (err.code === "NOT_IMPLEMENTED") {
    return res.status(501).json({ success: false, error: err.message, code: err.code });
  }
...
router.post("/categories", async (req, res) => {
  try {
    res.json({ success: true, data: await adminService.createCategory(req.user.id, req, req.body) });
  } catch (err) {
...
router.put("/categories/:id", async (req, res) => {
  try {
    res.json({ success: true, data: await adminService.updateCategory(req.user.id, req, req.params.id, req.body) });
  } catch (err) {
...
router.delete("/categories/:id", async (req, res) => {
  try {
    res.json({ success: true, data: await adminService.deleteCategory(req.user.id, req, req.params.id) });
  } catch (err) {
...
router.get("/providers/:categoryId", async (req, res) => {
  try {
    res.json({ success: true, data: await adminService.listProvidersAdmin(req.params.categoryId) });
  } catch (err) {
...
router.post("/providers", async (req, res) => {
  try {
    res.json({ success: true, data: await adminService.createProvider(req.user.id, req, req.body) });
  } catch (err) {
...
router.put("/providers/:id", async (req, res) => {
  try {
    res.json({ success: true, data: await adminService.updateProvider(req.user.id, req, req.params.id, req.body) });
  } catch (err) {
...
router.delete("/providers/:id", async (req, res) => {
  try {
    res.json({ success: true, data: await adminService.deleteProvider(req.user.id, req, req.params.id) });
  } catch (err) {
...
router.get("/plans/:providerId", async (req, res) => {
  try {
    res.json({ success: true, data: await adminService.listPlansAdmin(req.params.providerId) });
  } catch (err) {
...
router.post("/plans", async (req, res) => {
  try {
    res.json({ success: true, data: await adminService.createPlan(req.user.id, req, req.body) });
  } catch (err) {
...
router.put("/plans/:id", async (req, res) => {
  try {
    res.json({ success: true, data: await adminService.updatePlan(req.user.id, req, req.params.id, req.body) });
  } catch (err) {
...
router.delete("/plans/:id", async (req, res) => {
  try {
    res.json({ success: true, data: await adminService.deletePlan(req.user.id, req, req.params.id) });
  } catch (err) {
...
router.post("/plans/:providerId/refresh", async (req, res) => {
  try {
    res.json({ success: true, data: await adminService.refreshPlansFromProvider(req.params.providerId) });
  } catch (err) {
...
router.post("/pricing", async (req, res) => {
  try {
    res.json({ success: true, data: await adminService.upsertPricingRule(req.user.id, req, req.body) });
  } catch (err) {
...
router.post("/settings", async (req, res) => {
  try {
    ...
    res.json({ success: true, data: await adminService.setSetting(req.user.id, req, key, value) });
  } catch (err) {
