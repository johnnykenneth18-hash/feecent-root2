...
// Intentionally length-only. We don't require a mix of upper/lower/digits —
// composition rules like that mostly just push users toward "Password1"
// patterns and cause confusing rejections. Length is still enforced because
// it's the strongest single predictor of resistance to brute-force/guessing.
const password = z
  .string()
