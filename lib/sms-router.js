...
const { TermiiAdapter } = require("../feecent-sms/lib/sms/providers/termii-adapter");
const { AfricasTalkingAdapter } = require("./providers/africastalking-adapter");
const { BulkSmsNigeriaAdapter } = require("../feecent-sms/lib/sms/providers/bulksmsnigeria-adapter");
